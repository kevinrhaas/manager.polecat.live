...
const PUBLIC_KEY_B64 =
  'MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAE4qzJxEVbmv+I1RpYrsng3z6ts2exLySF51uYPyoSEkJneQbhiTmBD0P+2CF4XjYF/XVev6BrcOZcDUosftzJLA==';

const A_KEY   = 'manager.access';    // { grantedAt, via, label }
const ADM_KEY = 'manager.adminkey';  // admin private key (pkcs8 b64), admin device only
const INV_KEY = 'manager.invites';   // locally-kept list of minted invites
const REV_KEY = 'manager.revoked';   // locally-revoked jti list (instant, this device)
...
export const Access = new (class {
  ...
  async verifyAdminToken(token){
    try{
      ...
      const msg = enc.encode('manager-admin-check');
