...
const SECTIONS = [
  ...
  { id:'releases', title:'Releases & what’s new', body:`
    ...
    <p>The <b>Releases</b> section (in the rail) is the fleet-wide view: every project’s releases in one <b>time-grouped timeline</b> — newest first, grouped by day in CT — with summary stats (last 7/30 days, who shipped) and filters by project, kind, time range, and text. It’s the fastest way to see what improved across the whole suite recently. Click any release to jump to that project.</p>
